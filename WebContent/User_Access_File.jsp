		...
		<div class="center wow fadeInDown">
			...
			<table class="table table-responsive table-bordered">
				...
				<%
					...
					String strattck = "select * from tbl_access_info where User_Name='"
							+ name + "' and Status='Accept'";
				...
				<tr>
					...
					<td class="col-md-2" align="center"><label><%=rs1.getString("Status")%></label></td>
					<br>
					<td class="col-md-4" align="center"><a target="_blank"
						href="Key_Send_File.jsp?fid=<%=rs1.getString("A_id")%>,<%=rs1.getString("User_Name")%>,<%=rs1.getString("File_Name")%>"> <input
							type="button" class="btn btn-primary" value="Accept">
					</a></td>
